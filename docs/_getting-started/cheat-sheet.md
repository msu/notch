...
One scannable page of the most common Notch forms. Each section links to the full
reference under [Language](../../language/values/).
...
-n   !ok   not ok                  # unary
2 * 3 / 4 % 5    1 + 2 - 4         # arithmetic
2 < 3   2 <= 3   2 > 3   2 >= 3    # comparison
1 == 1   1 != 2                    # equality
